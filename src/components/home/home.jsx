...
const serviceCategories = [
  {
    ...
    description:
      "Get the latest devices on flexible payment plans with comprehensive coverage included.",
  },
  {
    id: 2,
    title: "Insurance",
    description:
      "Protect yourself and your assets with comprehensive insurance solutions tailored to your needs.",
  },
  {
    id: 3,
    title: "Investments",
    description:
      "Grow your wealth with investment plans designed to help you achieve your financial goals.",
  },
];
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8 bg-white">
      ...
      <section className="mt-16 mb-16">
        <div className="mb-12">
          <p className=" flex text-[11px] font-semibold uppercase tracking-[0.4em] text-slate-900 mb-3">
            What we offer
          </p>
      ...
      <section className="mt-10">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {featuredProducts.map((product) => (
            <div
              key={product.id}
              className="rounded-3xl bg-slate-50 p-4 ring-1 ring-slate-200/60"
            >
