...
const fetchClientData = async (userId) => {
    ...
    try { 
     ...
     const fetchDcoumentResponse = await axios.get(`/client/v1/profile/documents`,{
        headers: {Authorization:  `Bearer ${token}`},
        ...
        <div className="max-w-lg mx-auto">
            ...
            <div className="mb-8">
                ...
                <p className="text-slate-500 text-sm">
                    We are committed to providing a safe and secure experience. 
            ...
            <div className="space-y-4">
                ...
                >
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="font-semibold text-slate-900 mb-1">Proof of Residence</h3>
                ...
                >
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="font-semibold text-slate-900 mb-1">Selfie Upload</h3>
                            <p className="text-sm text-slate-500">Take a photo or upload a selfie</p>
                        </div>
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold
